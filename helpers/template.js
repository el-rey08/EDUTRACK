const schoolSignUpTemplate = (verifyLink, schoolName) => {
  return `
    <!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
  ...
  <div class="content">
    ...
    <p>Thank you for joining our community! We're thrilled to have your school on board.</p>
...
const studentSignUpTemplate = (verifyLink, firstName, studentID) => {
  return `
    <!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
  ...
  <div class="content">
    ...
    <p>Your initial password is your student ID: <strong>${studentID}</strong>. Please keep this safe.</p>
    <p>Please click the button below to verify your account:</p>
    <p>
      <a href="${verifyLink}" class="button">Verify My Account</a>
    </p>
...
const teacherSignUpTemplate = (verifyLink, firstName, teacherID) => {
  return `
    <!DOCTYPE html>
<html lang="en">
<head>
...
module.exports = {
   ...
   verifyTemplate,
    forgotPasswordTemplate,
     generateAttendanceEmailTemplate};
